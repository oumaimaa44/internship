...
entity neorv32_soc_top is
  generic (
    -- <clock_cfg>
    -- This is NOT the synthesis clock constraint. It is used by NEORV32
    -- for things like UART/timer divisors.
    CLOCK_FREQUENCY : natural := 100_000_000;
    -- </clock_cfg>

    -- <boot_cfg>
    -- 0 = bootloader, 1 = custom boot address, 2 = IMEM initialized with app image
    ...
    -- <xbus_cfg>
    -- Keep XBUS_EN=false for pure internal-memory simulation.
    ...
    -- Dummy generic so every Odatix-replaced block above may safely end with ';'.
...
begin
  ...
  u_neorv32 : entity neorv32.neorv32_top
    ...
    port map (
      ...
      -- UART0 exposed for CoreMark/performance simulation
