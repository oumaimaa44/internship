...
set top_level_module   neorv32_soc_top
set top_level_file     neorv32_soc_top.vhd

set clock_signal       clk_i
set reset_signal       rstn_i
...
set tmp_path           /net/users/oelmouden/neorv32/work/custom_freq_synthesis/vivado/xc7a100t-csg324-1/neorv32/neorv32_default/200MHz
...
set source_rtl_path    rtl/core
set source_arch_path   odatix_userconfig/architectures
...
set target_frequency   200
set fmax_lower_bound   None
set fmax_upper_bound   None
set fmax_explore       0
set fmax_mindiff       1
set fmax_safezone      5
...
set lib_name           LIB_xc7a100t-csg324-1_neorv32_neorv32_default_200MHz
