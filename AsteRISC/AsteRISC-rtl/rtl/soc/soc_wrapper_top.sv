...
module soc_wrapper_top #(
  ...
  parameter string p_imem_init = "/net/users/oelmouden/AsteRISC/AsteRISC-firmware/hex/Dhrystone_RV32IM/Dhrystone_benchmark_imem.hex",
  parameter string p_dmem_init = "/net/users/oelmouden/AsteRISC/AsteRISC-firmware/hex/Dhrystone_RV32IM/Dhrystone_benchmark_dmem.hex",
